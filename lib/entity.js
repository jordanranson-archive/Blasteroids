global.Entity = global.Class.extend({
    ...
    serialize: function() {
        return {
            pos: { x: this.pos.x.toFixed(10), y: this.pos.y.toFixed(10) },
            last: { x: this.last.x.toFixed(10), y: this.last.y.toFixed(10) },
            vel: { x: this.vel.x.toFixed(10), y: this.vel.y.toFixed(10) },
            size: this.size,

            angle: this.angle,
            maxVel: this.maxVel,
            rawSpeed: this.rawSpeed,
            friction: this.friction.toFixed(10),
